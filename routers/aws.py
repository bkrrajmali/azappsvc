...
def get_s3_buckets(request: Request, region: str)->list:
    ...
    #print(account_id)
    return templates.TemplateResponse("s3.html", {"request": request, "total_bucket_count": total_bucket_count, "name": "S3 BUCKET INFO FOR REGION","region": cap_region, "bucket_list": bucket_list, "account_id": account_id})
